...
public class TTT extends JFrame implements ActionListener {
 private static final long serialVersionUID = 1L;
	...
	private void initBoard() {
		...
		button = new ButtonComp[3][3];gameState = new int[3][3];
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
				button[i][j] = new ButtonComp(i, j, this);
				gameState[i][j] = 0;
	...
	public void buttonClicked(ButtonComp b) {
		// TODO Auto-generated method stub
		total++;
		if (turn == 0) {
...
//	}
	...
	public void computerTurn() {
		...
		ResultSet result = minimax(gameState, depth, alpha, beta, true);
